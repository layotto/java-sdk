...
public interface PubSubRxRuntime extends PubSubRuntime {
    ...
    Mono<Void> publishEventAsync(String pubsubName, String topicName, byte[] data);

    @Override
    default void publishEvent(String pubsubName, String topicName, byte[] data, Map<String, String> metadata) {
        publishEventAsync(pubsubName, topicName, data, metadata).block();
    }

    Mono<Void> publishEventAsync(String pubsubName, String topicName, byte[] data, Map<String, String> metadata);

    @Override
    default void publishEvent(String pubsubName, String topicName, byte[] data, String contentType, Map<String, String> metadata) {
        publishEventAsync(pubsubName, topicName, data, contentType, metadata).block();
    }

    Mono<Void> publishEventAsync(String pubsubName, String topicName, byte[] data, String contentType, Map<String, String> metadata);
    ...
    Mono<Void> publishEventAsync(PublishEventRequest request);
}
