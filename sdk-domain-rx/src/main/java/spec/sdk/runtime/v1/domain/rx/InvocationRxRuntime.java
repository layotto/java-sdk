...
public interface InvocationRxRuntime {
     ...
     */
    default InvokeResponse<byte[]> invokeMethod(String appId, String methodName, byte[] data, Map<String, String> header) {
        return invokeMethodAsync(appId, methodName, data, header).block();
    }

    Mono<InvokeResponse<byte[]>> invokeMethodAsync(String appId, String methodName, byte[] data, Map<String, String> header);
     ...
     * @return The response from the service call.
     */
    default InvokeResponse<byte[]> invokeMethod(String appId, String methodName, byte[] data, Map<String, String> header, int timeoutMs) {
        return invokeMethodAsync(appId, methodName, data, header, timeoutMs).block();
    }

    Mono<InvokeResponse<byte[]>> invokeMethodAsync(String appId, String methodName, byte[] data, Map<String, String> header, int timeoutMs);
}
